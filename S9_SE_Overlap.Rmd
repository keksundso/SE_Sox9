...
soxPath <- "Data/Sox9_UCSC_Peaks_detected_by_MACS_sorted.bed"
...
for (filePath in list.files(bedPath, full.names = TRUE, pattern = "*.bed")) {
    ...
    system(paste0("bedtools shuffle -i ",filePath," -g ",my.mm10Genome," > ",shuffeltName))
    system(paste0("bedtools sort -i ",shuffeltName, " > ",sortedshuffeltName ))
    
    system(paste0("bedtools sort -i ",filePath, " > ",sortedName ))
    system(paste0("bedtools closest -d -a ",sortedName, " -b ",soxPath, " > ", distancTable ))
    system(paste0("bedtools closest -d -a ",sortedshuffeltName, " -b ",soxPath, " > ", distancTableSuffeld ))
}
